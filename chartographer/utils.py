...
class ChartographerConfig:
    ...
    working_dir: str = "./chartographer_workspace"  # BookWorm working directory
    document_dir: str = "./chartographer_workspace/docs"
    processed_dir: str = "./chartographer_workspace/processed_docs"  # Align with examples
    output_dir: str = "./chartographer_workspace/output"
...
def load_config(env_file: Optional[str] = None) -> ChartographerConfig:
    ...
    config.working_dir = os.getenv("WORKING_DIR", "./chartographer_workspace")
...
def setup_logging(config: ChartographerConfig) -> logging.Logger:
    ...
    logger = logging.getLogger("chartographer")
    ...
    # File handler
    log_file = Path(config.log_dir) / "chartographer.log"
...
def ensure_directories(config: ChartographerConfig) -> None:
